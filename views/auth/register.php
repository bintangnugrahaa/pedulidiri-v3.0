                ...
                <div class="col-lg-4 mx-auto">
                    <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                        ...
                        <div class="text-center font-weight-light" style="margin-bottom: -20px;">
                            <a href="https://www.instagram.com/bintang_nugrahaa/" style="color: black; font-size:24px;" target="_blank"><i class="fa fa-instagram"></i></a>
                            <a href="https://github.com/bintangnugrahaa/" style="color: black; font-size:24px; margin-left:20px;" target="_blank"><i class="fa fa-github"></i></a>
                            <a href="https://www.linkedin.com/in/bintangnugraha/" style="color: black; font-size:24px; margin-left:20px;" target="_blank"><i class="fa fa-linkedin"></i></a>
                        </div>
                    </div>
                </div>
            </div>
